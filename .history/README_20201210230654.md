...
Whichever library you choose, be sure to read the documentation carefully!
  ...
  the Daily JS planner  allows the user to add events to its schechedul, this code is design for employess, the code can be modefied to be used by it can be built for students, employees,  
## User Story
